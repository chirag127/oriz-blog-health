# Health — `oriz-blog-health`

> Evidence over hype — nutrition, fitness, and wellbeing you can act on.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-health?style=flat)](https://github.com/chirag127/oriz-blog-health/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-health)](https://github.com/chirag127/oriz-blog-health/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-health/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-health/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Health** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A health and wellbeing blog on nutrition, fitness, sleep, and mental health — evidence-led and free of miracle-cure noise.

- **Live site:** https://health-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-health
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-health/ — the canonical, always-current site is **https://health-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-health/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>health-blog.oriz.in"]
...
oriz-blog-health/
├── src/
│   ├── content/blog/       # the health articles (MDX/Markdown)
